...
// Date: January 15, 2016 Edited by Natalia Perez
...
// write this function
	while(1) {
		SW1 = GPIO_PORTF_DATA_R&0x10;	// Read value of PF4 (SW1/AS)
		if(!SW1) {
			return;
		}
	}
...
void SetVT(void){
// write this function
	VT = GPIO_PORTF_DATA_R&0x02; //PF1 = VT, bit 1 = 2
...
void SetReady(void){
// write this function
	Ready = GPIO_PORTF_DATA_R&0x08;	//PF3 = Ready, bit 3 = 8
...
// write this function
	unsigned long i;
	while(msec > 0) {
		i = 1333333/100;	// this number means 1ms, 1333333 = 100ms
		while(i > 0) {
			i = i - 1;
		}
